...
def create_parse():
    parser = argparse.ArgumentParser(description='demo01')

    parser.add_argument('--device', type=str, default='cuda')
    parser.add_argument('--seed', type=int, default=1)

    parser.add_argument('--dataname', type=str, default='mmnist')
    ...
    parser.add_argument('--r_sampling_step_1', type=float, default=625)
    parser.add_argument('--r_sampling_step_2', type=int, default=1250)
    parser.add_argument('--r_exp_alpha', type=int, default=125)
